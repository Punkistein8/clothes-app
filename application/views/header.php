  ...
  <nav class="bg-gray-900">
    <div class="px-4 py-5 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8">
      <div class="relative flex items-center justify-between">
        ...
        <a href="<?= base_url('Login'); ?>" class="bg-teal-600 px-5 py-3 rounded-md text-white hover:bg-teal-700 transition-all ease-in-out">Administradores</a>
        <ul class="flex items-center  space-x-8 lg:flex">
          ...
          <li><a href="<?= base_url('Comidas') ?>" aria-label="Comida" title="Comidas" class="font-medium tracking-wide text-gray-100 transition-colors duration-200 hover:text-teal-400">Comidas</a></li>
        </ul>
      </div>
    </div>
  </nav>